    ...
    <>
      ...
      <div className="candidate-config-card mt-4">
        <div className="candidate-config-header">
          ...
          <p>
            Configure email based authentication and verification settings for
            candidates.
          </p>
        </div>
        ...
        <Row className="g-3">
          <Col lg={6}>
            <Form.Group>
              ...
              <Form.Select
                ...
                onChange={(e) => onChange("emailValidation", e.target.value)}
              >
                <option value="OTP">Email OTP Verification</option>
          ...
          <Col lg={6}>
            <Form.Group>
              <Form.Label>Allowed Email Domain</Form.Label>

              <Form.Control
                placeholder="example.com"
                value={data.allowedDomain || ""}
                onChange={(e) => onChange("allowedDomain", e.target.value)}
              />
            </Form.Group>
          </Col>
        </Row>
      ...
      <h5 className="candidate-section-title mt-4">Email Verification</h5>
          ...
          <div className="candidate-option-card">
            <div className="candidate-option-left">
              ...
              <div>
                ...
                <small>Verify candidate email using OTP.</small>
              </div>
            </div>
            ...
            <Form.Check
              ...
              onChange={(e) => onChange("emailOtp", e.target.checked)}
            />
          </div>
        </Col>
          ...
          <div className="candidate-option-card">
            <div className="candidate-option-left">
              ...
              <div>
                ...
                <small>Send verification link during registration.</small>
              </div>
            </div>
            ...
            <Form.Check
              ...
              onChange={(e) => onChange("emailLink", e.target.checked)}
            />
          </div>
        </Col>
      </Row>
      ...
      <h5 className="candidate-section-title mt-4">Email Security</h5>
          ...
          <div className="candidate-option-card">
            <div className="candidate-option-left">
              ...
              <div>
                ...
                <small>Prevent temporary email services.</small>
              </div>
            </div>
            ...
            <Form.Check
              ...
              onChange={(e) => onChange("blockDisposable", e.target.checked)}
            />
          </div>
        </Col>
          ...
          <div className="candidate-option-card">
            <div className="candidate-option-left">
              ...
              <div>
                ...
                <small>Multiple candidates can use same email.</small>
              </div>
            </div>
            ...
            <Form.Check
              ...
              onChange={(e) =>
                onChange("allowDuplicateEmail", e.target.checked)
              }
            />
          </div>
        </Col>
          ...
          <div className="candidate-option-card">
            <div className="candidate-option-left">
              ...
              <div>
                ...
                <small>Email login requires password.</small>
              </div>
            </div>
          ...
          <div className="candidate-option-card">
            <div className="candidate-option-left">
              ...
              <div>
                ...
                <small>Remember email on trusted devices.</small>
              </div>
            </div>
            ...
            <Form.Check
              ...
              onChange={(e) => onChange("rememberEmail", e.target.checked)}
            />
          </div>
        </Col>
      </Row>

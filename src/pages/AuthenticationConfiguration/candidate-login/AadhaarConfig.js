    ...
    <>
      ...
      <div className="candidate-config-card">
        ...
        <div className="candidate-config-header">
          ...
          <p>
            Configure Aadhaar authentication, verification and e-KYC
            settings for candidate login.
          </p>
          ...
          <Col lg={6}>
            ...
            <Form.Group>
              ...
              >
                ...
                <option value="XXXX-XXXX-1234">
                  XXXX-XXXX-1234
                </option>

                <option value="123412341234">
                  123412341234
                </option>
          ...
          <div className="candidate-option-card">
            ...
            <div className="candidate-option-left">
              ...
              <div>
                ...
                <small>
                  Verify Aadhaar before allowing login.
                </small>

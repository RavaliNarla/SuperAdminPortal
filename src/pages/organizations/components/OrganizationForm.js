...
useEffect(() => {
    ...
    try {
      ...
      setFormData({
        ...
        secondaryColor:
          ...
          organization.theme?.secondaryColor ||
          "#6610f2",
        loginBackgroundUrl: organization.loginBackgroundUrl || "",
        contactPerson: organization.contactPerson || "",
        email: organization.email || organization.contact?.email || "",
        phone: organization.phone || organization.contact?.phone || "",
        website: organization.website || "",
        address: organization.address || organization.contact?.address || "",
        ...
        admin: {
          ...
          temporaryPassword: organization.admin?.temporaryPassword || "",
        },
        subscription: {
        ...
        regional: {
          timezone:
            organization.regional?.timezone || "Asia/Kolkata",
          language:
            organization.regional?.language || "English",
          currency:
            organization.regional?.currency || "INR",
          dateFormat:
            organization.regional?.dateFormat || "DD/MM/YYYY",
        },
        modules: {
          candidatePortal:
            organization.modules?.candidatePortal ?? true,
          recruitmentPortal:
            organization.modules?.recruitmentPortal ?? true,
        },
  ...
  //     dispatch(
  //       createOrganization({
  //         organizationDetailsJson: payload,
  //       })
  //     );
  //   }
  ...
  return (
    <div className="card-bg card-body" id="orgForm">
            ...
            <div className="row g-4">
              ...
              <div className="col-lg-4 col-md-6">
                ...
                <input
                  type="text"
                  maxLength={15}
                  className={`form-control modern-input ${errors.code ? "is-invalid" : ""}`}
              ...
              <div className="col-lg-4 col-md-6">
                ...
                <select
                  className={`form-select modern-input  ${errors.type ? "is-invalid" : ""}`}
                  value={formData.type}
                  onChange={(e) =>
              ...
              <div className="col-lg-4 col-md-6">
                ...
                <input
                  type="text"
                  className={`form-control modern-input ${errors.domain ? "is-invalid" : ""}`}

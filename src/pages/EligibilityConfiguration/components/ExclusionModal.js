...
const ExclusionModal = ({ show, onClose, onCreate, exclusion, isViewMode }) => {
  ...
  useEffect(() => {
    if (exclusion) {
      setFormData({
        name: exclusion.name || "",
        actionType: exclusion.actionType || "Reject Immediately",
        requiredDocuments: exclusion.requiredDocuments || [],
      ...
      <div className="category-modal">
        ...
        <div className="category-modal-body">
          {!isViewMode && (
            <div className="warning-box">
              ...
              Once saved, this rule cannot be edited. Disable it and create a
              revised version.
            </div>
          )}
          ...
          <div className="mb-3">
            ...
            <div className="d-flex gap-3 mt-2">
              <button
                ...
                disabled={isViewMode}
                onClick={() => handleChange("actionType", "Reject Immediately")}
              >
                Reject Immediately
              </button>
              ...
              <button
                ...
                disabled={isViewMode}
                onClick={() => handleChange("actionType", "Warning")}
              >
                Warning
              </button>
            </div>
            ...
            <div className="mb-3">
              ...
              <Autocomplete
                ...
                onChange={(event, value) => {
                  ...
                  handleChange("requiredDocuments", value);
                }}
                renderInput={(params) => (
                  <TextField
                    {...params}
        ...
        <div className="category-modal-footer">
          ...
          {!isViewMode && (
            ...
            >
              {exclusion ? "Save Revised Version" : "Create"}
            </button>
          )}
        </div>
      </div>

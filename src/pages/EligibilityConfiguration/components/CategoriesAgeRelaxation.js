            ...
            <div className="category-header">
                <div>
                    ...
                    <p className="section-subtitle">
                        Configure vertical & horizontal reservation
                        categories and age relaxation rules.
                    </p>
                </div>
                <button
            ...
            <div className="organization-card">
                <div className="card-body">
                    <div className="section-header mb-4">
                        <div>
                            <h5 className="section-title">
                                Global Age Relaxation Settings
                            </h5>
                            <p className="section-subtitle">
                                Configure organization level age
                                relaxation policies.
                            </p>
                        </div>
                    </div>
                    <div className="row">
                        ...
                        <div className="col-lg-6">
                            <div className="setting-item">
                                <div>
                                    <h6>
                                        Reserved Vacancy Required
                                    </h6>
                                    <small>
                                        Apply relaxation only when reserved
                                        vacancies exist.
                                    </small>
                                </div>
                                <div className="form-check form-switch">
                                    <input
                                        ...
                                        onChange={() =>
                                            handleToggle("reservedVacancyOnly")
                                        }
                                    />
                                </div>
                            </div>
                        ...
                        <div className="col-lg-6 mt-4">
                            <div className="setting-item">
                                <div>
                                    <h6>
                                        Allow Multiple Relaxations
                                    </h6>
                                    <small>
                                        Candidate can avail multiple
                                        relaxations together.
                                    </small>
                                </div>
                                <div className="form-check form-switch">
                                    <input
                                        ...
                                        onChange={() =>
                                            handleToggle("allowMultipleRelaxation")
                                        }
                                    />
                                </div>
                            </div>

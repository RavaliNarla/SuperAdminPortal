...
const CategoryModal = ({ show, onClose, onCreate, category, isViewMode }) => {
      ...
      setFormData({
        ...
        categoryType:
          category.type === "Horizontal"
            ? "Horizontal Category"
            : "Vertical Category",
        ageRelaxation: category.ageRelaxation?.replace(" Years", "") || "",
  ...
  const handleCreate = () => {
    const categoryPayload = {
      name: formData.name,
      type:
        formData.categoryType === "Vertical Category"
          ? "Vertical"
          : "Horizontal",
        ...
        <div className="category-modal-body">
          {!category && (
            <div className="warning-box">
              ...
              Once saved, this rule is permanent and cannot be edited. To
              correct it later, disable it and create a revised version.
            </div>
          )}
          ...
          <div className="mb-3">
            ...
            <small className="text-muted">
              Mutually exclusive per candidate (e.g. General, SC, ST, OBC, EWS)
            </small>
          </div>

          <div className="mb-3">
            <label className="form-label">Age Relaxation (Years)</label>
            ...
            <input
              ...
              onChange={(e) => handleChange("ageRelaxation", e.target.value)}
            />
          </div>
